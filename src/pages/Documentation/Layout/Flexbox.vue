<template>
  <container>
    ...
    <p>
      Add the <code>columns</code> component to a <code>container</code>. And add any element(s) you want with the
      <code>column</code> component. These columns will take up the space equally. You can specific the width of each
...
export default defineComponent({
  ...
  <columns>
    ...
    gapless: `<columns gapless>
  <column col=6>...</column>
  <column col=6>...</column>
</columns>`,

    oneline: `<columns oneline>
  <column col=8>...</column>
  <column col=12>...</column>
</columns>`,
